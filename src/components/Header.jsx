...
import "./Header.css";
import desconecta from "../assets/desconecta.png";

const Header = () => {
  return (
    <header className="header-section text-white d-flex align-items-center px-lg-5 pb-lg-5">
      <div className="container-fluid">
        ...
        <div className="col-12 col-md-6 mt-5 text-center text-md-start">
          ...
          <p className="fs-5 lh-base text-container">
          ...
          <button className="btn btn-outline-light btn-lg fw-bold fs-4 text-center">
